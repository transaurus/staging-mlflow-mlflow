...
MLflow's flavor design ensures a degree of uniformity. For every library, its corresponding MLflow flavor defines the behavior of the loaded [`pyfunc`](/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc) for inference deployment. Each flavor prescribes a `predict` method behavior, ensuring a consistent yet somewhat rigid format.

To understand these constraints, consider the [`sklearn`](/docs/latest/api_reference/python_api/mlflow.sklearn.html#mlflow.sklearn) flavor as an example. The diagram below delineates its implementation, highlighting the APIs and serialization methods MLflow has standardized:

![MLflow\&#39;s sklearn implementation](/docs/latest/assets/images/anatomy_of_a_model_flavor-0cec4787fa4efd6ebc30c2988de5ebe1.svg)
...
![Components of a Model in MLflow](/docs/latest/assets/images/anatomy-of-a-model-8b14760a287cc3ef7464858dcaf8cf90.svg)
...
![Components of a Model in the MLflow UI](/docs/latest/assets/images/model-components-in-ui-90bbf96c9e4e4a9887b815b156531d1e.svg)
